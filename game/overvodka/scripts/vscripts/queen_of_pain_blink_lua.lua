...
LinkLuaModifier( "modifier_dark_seer_vacuum_lit", "modifier_dark_seer_vacuum_lit", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_litvin_enrage", "modifier_litvin_enrage", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_litvin_litenergy", "modifier_litvin_litenergy", LUA_MODIFIER_MOTION_NONE )

function queen_of_pain_blink_lua:Precache( context )
	PrecacheResource( "soundfile", "soundevents/game_sounds_heroes/game_sounds_dark_seer.vsndevts", context )
	PrecacheResource( "particle", "particles/dark_seer_vacuum_new.vpcf", context )
end

function queen_of_pain_blink_lua:GetAOERadius()
	return self:GetSpecialValueFor( "radius" )
end
--------------------------------------------------------------------------------
function queen_of_pain_blink_lua:OnAbilityPhaseStart()
...
--------------------------------------------------------------------------------
function queen_of_pain_blink_lua:PlayEffects( origin, direction, point, radius )
	-- Get Resources
