...
LinkLuaModifier( "modifier_aghanim_staff_beams_thinker", "modifier_aghanim_staff_beams_thinker", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_aghanim_staff_beams_linger_thinker", "modifier_aghanim_staff_beams_linger_thinker", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_aghanim_staff_beams_debuff", "modifier_aghanim_staff_beams_debuff", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_stariy_fly", "modifier_stariy_fly", LUA_MODIFIER_MOTION_NONE )
...
function aghanim_staff_beams:OnAbilityPhaseInterrupted()
