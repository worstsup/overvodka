...
function modifier_primal_beast_onslaught_lua:CheckState()
	local state = {
...
function modifier_primal_beast_onslaught_lua:GetModifierModelChange()
	return "bmw/models/heroes/bm/bmwe90.vmdl"
end

function modifier_primal_beast_onslaught_lua:GetModifierModelScale()
