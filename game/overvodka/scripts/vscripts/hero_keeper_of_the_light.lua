...
LinkLuaModifier("modifier_special_bonus_imba_keeper_of_the_light_ignis_truesight", "hero_keeper_of_the_light", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_special_bonus_imba_keeper_of_the_light_travelling_light", "hero_keeper_of_the_light", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_special_bonus_imba_keeper_of_the_light_flow_inhibition", "hero_keeper_of_the_light", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_special_bonus_imba_keeper_of_the_light_pure_illuminate", "hero_keeper_of_the_light", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_special_bonus_imba_keeper_of_the_light_luminous_burster", "hero_keeper_of_the_light", LUA_MODIFIER_MOTION_NONE)
