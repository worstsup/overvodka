...
LinkLuaModifier( "modifier_spectre_haunt_lua", "modifier_spectre_haunt_lua.lua", LUA_MODIFIER_MOTION_NONE )
...
function spectre_reality_lua:IsStealable()
	return false
end
