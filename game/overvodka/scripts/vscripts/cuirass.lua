LinkLuaModifier("modifier_item_cuirass_2", "cuirass", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cuirass_2_aura_buff", "cuirass", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cuirass_2_aura_buff_armor", "cuirass", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cuirass_2_aura_debuff", "cuirass", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cuirass_2_aura_debuff_armor", "cuirass", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_ship_magic_armor", "cuirass", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_bristback_ship", "boss_items", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_birzha_blade_mail", "cuirass", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_birzha_blade_mail_active", "cuirass", LUA_MODIFIER_MOTION_NONE)
