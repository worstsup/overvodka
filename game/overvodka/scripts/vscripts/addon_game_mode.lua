...
function Precache( context )
	...
	-- Cache overthrow-specific sounds
		...
		PrecacheResource( "soundfile", "soundevents/pres.vsndevts", context )
		...
		PrecacheResource( "soundfile", "soundevents/serega_opa.vsndevts", context )
...
--	CustomNetTables:SetTableValue( "test", "value 2", { a = 1, b = 2 } );
	...
	GameRules:GetGameModeEntity():SetDefaultStickyItem( "item_balbe" )
