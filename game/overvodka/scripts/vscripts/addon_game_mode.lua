...
function Precache( context )
	...
	--Cache the creature models
		...
		PrecacheResource("soundfile", "soundevents/swag.vsndevts", context)
		PrecacheResource("particle", "particles/swag_start.vpcf", context)
		PrecacheResource("particle", "particles/swag_effect.vpcf", context)
		PrecacheResource("particle", "particles/swag_shield.vpcf", context)
		PrecacheResource("particle", "particles/swag_head.vpcf", context)
