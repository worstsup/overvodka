...
function peterka_q:OnSpellStart()
    ...
    target:AddNewModifier(caster, self, "modifier_peterka_q", {duration = duration * (1 - target:GetStatusResistance()), damage = damage})
    ...
    telka:AddNewModifier(caster, self, "modifier_telka", {duration = duration * (1 - target:GetStatusResistance())})
