modifier_arsen_tg_wall_aura = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_arsen_tg_wall_aura:IsHidden()
	return true
end

function modifier_arsen_tg_wall_aura:IsDebuff()
	return true
end

function modifier_arsen_tg_wall_aura:IsPurgable()
	return true
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_arsen_tg_wall_aura:OnCreated( kv )
...
function modifier_arsen_tg_wall_aura:OnRefresh( kv )
end

function modifier_arsen_tg_wall_aura:OnRemoved()
end

function modifier_arsen_tg_wall_aura:OnDestroy()
end

--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_arsen_tg_wall_aura:DeclareFunctions()
	local funcs = {
...
function modifier_arsen_tg_wall_aura:GetModifierMoveSpeed_Limit( params )
	if not IsServer() then return end
	-- do nothing if owner
...
--------------------------------------------------------------------------------
-- Helper
function modifier_arsen_tg_wall_aura:Interpolate( value, min, max )
	return value*(max-min) + min
end

--------------------------------------------------------------------------------
-- Aura Effects
function modifier_arsen_tg_wall_aura:IsAura()
	return self.owner
end

function modifier_arsen_tg_wall_aura:GetModifierAura()
	return "modifier_arsen_tg_wall_aura"
end

function modifier_arsen_tg_wall_aura:GetAuraRadius()
	return self.aura_radius
end

function modifier_arsen_tg_wall_aura:GetAuraDuration()
	return 0.3
end

function modifier_arsen_tg_wall_aura:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end

function modifier_arsen_tg_wall_aura:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end

function modifier_arsen_tg_wall_aura:GetAuraSearchFlags()
	return 0
end

function modifier_arsen_tg_wall_aura:GetAuraEntityReject( unit )
	if not IsServer() then return end
