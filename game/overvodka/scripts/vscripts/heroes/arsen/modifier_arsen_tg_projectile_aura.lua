modifier_arsen_tg_projectile_aura = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_arsen_tg_projectile_aura:IsHidden()
	return false
end

function modifier_arsen_tg_projectile_aura:IsDebuff()
	return false
end

function modifier_arsen_tg_projectile_aura:IsStunDebuff()
	return false
end

function modifier_arsen_tg_projectile_aura:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_arsen_tg_projectile_aura:OnCreated( kv )
...
function modifier_arsen_tg_projectile_aura:OnRefresh( kv )
	
end

function modifier_arsen_tg_projectile_aura:OnRemoved()
end

function modifier_arsen_tg_projectile_aura:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Filter Effects
function modifier_arsen_tg_projectile_aura:ProjectileFilter( data )
	-- get data
	...
	local mod1 = attacker:FindModifierByNameAndCaster( 'modifier_arsen_tg_projectile_aura', self:GetCaster() )
	local mod2 = target:FindModifierByNameAndCaster( 'modifier_arsen_tg_projectile_aura', self:GetCaster() )
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_arsen_tg_projectile_aura:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Aura Effects
function modifier_arsen_tg_projectile_aura:IsAura()
	return self.owner
end

function modifier_arsen_tg_projectile_aura:GetModifierAura()
	return "modifier_arsen_tg_projectile_aura"
end

function modifier_arsen_tg_projectile_aura:GetAuraRadius()
	return self.radius
end

function modifier_arsen_tg_projectile_aura:GetAuraDuration()
	return 0.3
end

function modifier_arsen_tg_projectile_aura:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_BOTH
end

function modifier_arsen_tg_projectile_aura:GetAuraSearchType()
	return DOTA_UNIT_TARGET_ALL
end

function modifier_arsen_tg_projectile_aura:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES + DOTA_UNIT_TARGET_FLAG_INVULNERABLE
end

function modifier_arsen_tg_projectile_aura:GetAuraEntityReject( hEntity )
	if IsServer() then
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_arsen_tg_projectile_aura:PlayEffects( loc )
	-- Get Resources
