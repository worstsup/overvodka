modifier_arsen_tg_spear_aura = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_arsen_tg_spear_aura:IsHidden()
	return true
end

function modifier_arsen_tg_spear_aura:IsDebuff()
	return true
end

function modifier_arsen_tg_spear_aura:IsPurgable()
	return true
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_arsen_tg_spear_aura:OnCreated( kv )
	-- references
...
function modifier_arsen_tg_spear_aura:OnRefresh( kv )
	
end

function modifier_arsen_tg_spear_aura:OnRemoved()
end

function modifier_arsen_tg_spear_aura:OnDestroy()
end

--------------------------------------------------------------------------------
-- Aura Effects
function modifier_arsen_tg_spear_aura:IsAura()
	return self.owner
end

function modifier_arsen_tg_spear_aura:GetModifierAura()
	return "modifier_arsen_tg_spear_aura"
end

function modifier_arsen_tg_spear_aura:GetAuraRadius()
	return self.radius
end

function modifier_arsen_tg_spear_aura:GetAuraDuration()
	return self.duration
end

function modifier_arsen_tg_spear_aura:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end

function modifier_arsen_tg_spear_aura:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end

function modifier_arsen_tg_spear_aura:GetAuraSearchFlags()
	return 0
end
function modifier_arsen_tg_spear_aura:GetAuraEntityReject( unit )
	if not IsServer() then return end
	...
	if unit:FindModifierByNameAndCaster( "modifier_arsen_tg_spear_aura", self:GetCaster() ) then
		return true
	end
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_arsen_tg_spear_aura:PlayEffects( direction )
	-- Get Resources
