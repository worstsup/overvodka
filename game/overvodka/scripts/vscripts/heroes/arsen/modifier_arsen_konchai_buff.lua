...
function modifier_arsen_konchai_buff:IsHidden() return false end
function modifier_arsen_konchai_buff:IsDebuff() return false end
function modifier_arsen_konchai_buff:IsStunDebuff() return false end
function modifier_arsen_konchai_buff:IsPurgable() return true end
