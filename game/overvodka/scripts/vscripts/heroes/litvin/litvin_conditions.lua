...
function modifier_litvin_conditions:IsHidden() return true end
function modifier_litvin_conditions:IsDebuff() return self:GetCaster():GetTeamNumber()~=self:GetParent():GetTeamNumber() end
function modifier_litvin_conditions:IsStunDebuff() return true end
function modifier_litvin_conditions:IsPurgable() return true end
