...
LinkLuaModifier( "modifier_invoker_ghost_walk_lua", "modifier_invoker_ghost_walk_lua.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_invoker_ghost_walk_lua_debuff", "modifier_invoker_ghost_walk_lua_debuff.lua", LUA_MODIFIER_MOTION_NONE )
