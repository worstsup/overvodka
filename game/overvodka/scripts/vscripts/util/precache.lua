...
PrecacheUtils.particles = {
		...
		"particles/items/cheaters_glasses.vpcf",
		...
		"particles/alchemist_smooth_criminal_unstable_concoction_explosion_fire_dark_new.vpcf",
		"particles/items2_fx/vindicators_axe_armor.vpcf",
		"particles/units/heroes/hero_marci/marci_unleash_buff.vpcf",
		"particles/flash_r_start_immortal.vpcf",
...
PrecacheUtils.models = {
		...
		"macan/macan_arcana/macanarcana.vmdl",
		"sasavot/sasavot_arcana/sasavotarcana.vmdl",
		"models/arsen/arsen_skin/arsen_skin_arena.vmdl",
		"models/arsen/arsen_skin/arsen_skin.vmdl",
		...
		"models/leon/leon_arcana/leon_wolf_geo.vmdl",
