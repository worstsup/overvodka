...
chillzone = class({})
LinkLuaModifier( "modifier_chillzone_thinker", "modifier_chillzone_thinker", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_chillzone_effect", "modifier_chillzone_effect", LUA_MODIFIER_MOTION_NONE )
