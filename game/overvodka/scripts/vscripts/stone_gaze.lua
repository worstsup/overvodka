...
function StoneGaze( keys )
    ...
    local ability_level = caster:FindAbilityByName("invoker_wex_lua"):GetLevel() - 1
...
function StoneGazeFacing( keys )
    ...
    local target = keys.target
    local ability = keys.ability
    local ability_level = caster:FindAbilityByName("invoker_wex_lua"):GetLevel() + caster:FindAbilityByName("invoker_quas_lua"):GetLevel() + caster:FindAbilityByName("invoker_exort_lua"):GetLevel() - 1
