...
LinkLuaModifier("modifier_item_oboyudno_2_aura_buff", "items/oboyudno_2", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_oboyudno_2_aura_buff_armor", "items/oboyudno_2", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_oboyudno_2_aura_debuff", "items/oboyudno_2", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_oboyudno_2_aura_debuff_armor", "items/oboyudno_2", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_ship_magic_armor", "items/oboyudno_2", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_birzha_blade_mail", "items/oboyudno_2", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_birzha_blade_mail_active", "items/oboyudno_2", LUA_MODIFIER_MOTION_NONE)
