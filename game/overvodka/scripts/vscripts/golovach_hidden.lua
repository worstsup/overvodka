...
LinkLuaModifier( "modifier_golovach_hidden", "modifier_golovach_hidden", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_golovach_slow", "modifier_golovach_slow", LUA_MODIFIER_MOTION_HORIZONTAL )
