...
LinkLuaModifier( "modifier_underlord_firestorm_lua", "modifier_underlord_firestorm_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_underlord_firestorm_lua_thinker", "modifier_underlord_firestorm_lua_thinker", LUA_MODIFIER_MOTION_NONE )
