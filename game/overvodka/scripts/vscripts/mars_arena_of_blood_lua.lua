...
LinkLuaModifier( "modifier_mars_arena_of_blood_lua_spear_aura", "modifier_mars_arena_of_blood_lua_spear_aura", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_mars_arena_of_blood_lua_projectile_aura", "modifier_mars_arena_of_blood_lua_projectile_aura", LUA_MODIFIER_MOTION_NONE )
