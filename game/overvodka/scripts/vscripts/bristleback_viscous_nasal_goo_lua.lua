...
LinkLuaModifier( "modifier_bristleback_viscous_nasal_goo_lua", "modifier_bristleback_viscous_nasal_goo_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_bristleback_viscous_nasal_goo_lua_buff", "modifier_bristleback_viscous_nasal_goo_lua_buff", LUA_MODIFIER_MOTION_NONE )
...
function bristleback_viscous_nasal_goo_lua:OnProjectileHit( hTarget, vLocation )
	...
	if hTarget:IsRealHero() then
		...
		caster, -- player source
		self, -- ability source
		"modifier_bristleback_viscous_nasal_goo_lua_buff", -- modifier name
