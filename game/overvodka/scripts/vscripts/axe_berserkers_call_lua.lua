...
LinkLuaModifier( "modifier_axe_berserkers_call_lua", "modifier_axe_berserkers_call_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_axe_berserkers_call_lua_debuff", "modifier_axe_berserkers_call_lua_debuff", LUA_MODIFIER_MOTION_NONE )
